          ...
          >
            <div class="form-container sign-up-container">
              <form action="#">
                ...
                <input
                  onChange={(event) => {
                    this.setState({ signUp_email: event.currentTarget.value });
                  }}
                  type="email"
                  placeholder="Email"
                />
                ...
                <GenderInputSelect
                  onChange={(event) => {
                    this.setState({ signUp_gender: event.currentTarget.value });
                  }}
                />
                <input
                  onChange={(event) => {
                    this.setState({ signUp_number: event.currentTarget.value });
                  }}
                  type="number"
                ...
                <input
                  onChange={(event) => {
                    this.setState({
                      signUp_emergencyContactNumber: event.currentTarget.value,
                    });
                  }}
                  type="number"
              ...
              <div class="overlay">
                ...
                <div class="overlay-panel overlay-right">
                  ...
                  <button
                    class="ghost"
                    id="signUp"
                    onClick={() => this.setState({ isContainerActive: true })}
                  >
                    Sign Up
                  </button>
                </div>
